...
module.exports = "<div class=\"row\">\r\n  <table class=\"table-responsive\" aria-describedby=\"Skills\">\r\n    <tbody>\r\n      <tr>\r\n        <th id=\"WebTech\">\r\n          <mdb-card class=\"card\" (mouseover)=\"webCardAnimate('start')\">\r\n            <mdb-card-body>\r\n              <mdb-card-title>\r\n                <h4>Web Technologies</h4>\r\n              </mdb-card-title>\r\n              <canvas mdbChart\r\n              [chartType]=\"chartType\"\r\n              [datasets]=\"webData\"\r\n              [labels]=\"webLabel\"\r\n              [colors]=\"chartColors\"\r\n              [options]=\"chartOptions\"\r\n              [legend]=\"true\"\r\n              (chartHover)=\"chartHovered($event)\"\r\n              (chartClick)=\"chartClicked($event)\">\r\n            </canvas>\r\n            </mdb-card-body>\r\n          </mdb-card>\r\n        </th>\r\n        <th id=\"Core\">\r\n          <mdb-card class=\"card\" [@animator]=\"coreCard\" (mouseover)=\"coreCardAnimate('start')\">\r\n            <mdb-card-body>\r\n              <mdb-card-title>\r\n                <h4>Core Framework</h4>\r\n              </mdb-card-title>\r\n              <canvas mdbChart\r\n              [chartType]=\"chartType\"\r\n              [datasets]=\"coreData\"\r\n              [labels]=\"coreLabel\"\r\n              [colors]=\"chartColors\"\r\n              [options]=\"chartOptions\"\r\n              [legend]=\"true\"\r\n              (chartHover)=\"chartHovered($event)\"\r\n              (chartClick)=\"chartClicked($event)\">\r\n            </canvas>\r\n            </mdb-card-body>\r\n          </mdb-card>\r\n        </th>\r\n      </tr>\r\n      <tr>\r\n        <th id=\"Server-Side\">\r\n          <mdb-card class=\"card\" [@animator]=\"serverCard\" (mouseover)=\"serverCardAnimate('start')\">\r\n            <mdb-card-body>\r\n              <mdb-card-title>\r\n                <h4>Server-Side</h4>\r\n              </mdb-card-title>\r\n              <canvas mdbChart\r\n              [chartType]=\"chartType\"\r\n              [datasets]=\"serverData\"\r\n              [labels]=\"serverLabel\"\r\n              [colors]=\"chartColors\"\r\n              [options]=\"chartOptions\"\r\n              [legend]=\"true\"\r\n              (chartHover)=\"chartHovered($event)\"\r\n              (chartClick)=\"chartClicked($event)\">\r\n            </canvas>\r\n            </mdb-card-body>\r\n          </mdb-card>\r\n        </th>\r\n        <th id=\"TestingTools\">\r\n          <mdb-card class=\"card\" [@animator]=\"testCard\" (mouseover)=\"testCardAnimate('start')\">\r\n            <mdb-card-body>\r\n              <mdb-card-title>\r\n                <h4>Testing Tools</h4>\r\n              </mdb-card-title>\r\n              <canvas mdbChart \r\n              [chartType]=\"chartType\"\r\n              [datasets]=\"testData\"\r\n              [labels]=\"testLabel\"\r\n              [colors]=\"chartColors\"\r\n              [options]=\"chartOptions\"\r\n              [legend]=\"true\"\r\n              (chartHover)=\"chartHovered($event)\"\r\n              (chartClick)=\"chartClicked($event)\">\r\n            </canvas>\r\n            </mdb-card-body>\r\n          </mdb-card>\r\n        </th>\r\n      </tr>\r\n      <tr>\r\n        <th id=\"DevOps\">\r\n          <mdb-card class=\"card\" [@animator]=\"devCard\" (mouseover)=\"devCardAnimate('start')\">\r\n            <mdb-card-body>\r\n              <mdb-card-title>\r\n                <h4>DevOps</h4>\r\n              </mdb-card-title>\r\n              <canvas mdbChart\r\n              [chartType]=\"chartType\"\r\n              [datasets]=\"devData\"\r\n              [labels]=\"devLabel\"\r\n              [colors]=\"chartColors\"\r\n              [options]=\"chartOptions\"\r\n              [legend]=\"true\"\r\n              (chartHover)=\"chartHovered($event)\"\r\n              (chartClick)=\"chartClicked($event)\">\r\n            </canvas>\r\n            </mdb-card-body>\r\n          </mdb-card>\r\n        </th>\r\n        <th id=\"Web&Micro\">\r\n          <mdb-card class=\"card\" [@animator]=\"servicesCard\" (mouseover)=\"servicesCardAnimate('start')\">\r\n            <mdb-card-body>\r\n              <mdb-card-title>\r\n                <h4>Web & Micro services</h4>\r\n              </mdb-card-title>\r\n              <canvas mdbChart\r\n              [chartType]=\"chartType\"\r\n              [datasets]=\"servicesData\"\r\n              [labels]=\"servicesLabel\"\r\n              [colors]=\"chartColors\"\r\n              [options]=\"chartOptions\"\r\n              [legend]=\"true\"\r\n              (chartHover)=\"chartHovered($event)\"\r\n              (chartClick)=\"chartClicked($event)\">\r\n            </canvas>\r\n            </mdb-card-body>\r\n          </mdb-card>\r\n        </th>\r\n      </tr>\r\n      <tr>\r\n        <th id=\"Languages\">\r\n          <mdb-card class=\"card\" [@animator]=\"langCard\" (mouseover)=\"langCardAnimate('start')\">\r\n            <mdb-card-body>\r\n              <mdb-card-title>\r\n                <h4>Languages</h4>\r\n              </mdb-card-title>\r\n              <canvas mdbChart\r\n              [chartType]=\"chartType\"\r\n              [datasets]=\"langData\"\r\n              [labels]=\"langLabel\"\r\n              [colors]=\"chartColors\"\r\n              [options]=\"chartOptions\"\r\n              [legend]=\"true\"\r\n              (chartHover)=\"chartHovered($event)\"\r\n              (chartClick)=\"chartClicked($event)\">\r\n            </canvas>\r\n            </mdb-card-body>\r\n          </mdb-card>\r\n        </th>\r\n      </tr>\r\n    </tbody>\r\n  </table>\r\n</div>\r\n"
...
/* harmony import */ var _services_logging_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./services/logging.service */ "./src/app/services/logging.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [
                ...
                _services_logging_service__WEBPACK_IMPORTED_MODULE_20__["LoggingService"],
...
module.exports = ".row {\n  margin-left: 10%;\n  margin-right: 10%;\n  text-align: center; }\n\n.card {\n  margin: 10%;\n  background: linear-gradient(to bottom, #7283a7, #45526e);\n  color: #d0d6e2;\n  min-width: 400px; }\n\n.tr, th {\n  padding: 3%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".row {\n  margin-left: 10%;\n  margin-right: 10%;\n  text-align: center; }\n\n.card {\n  margin: 10%;\n  background: linear-gradient(to bottom, #7283a7, #45526e);\n  color: #d0d6e2;\n  min-width: 400px; }\n\n.tr, th {\n  padding: 3%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoggingService = /** @class */ (function () {
    ...
    LoggingService.prototype.debug = function (message) {
        ...
        var date = Object(_angular_common__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(rawDate, 'medium', 'en-us');
...
var ValidationService = /** @class */ (function () {
     ...
     */
    ValidationService.prototype.validInput = function (text, field) {
        var message = '';
        if (!text) {
            switch (field) {
                case 'name':
