...
/*!*****************************************!*\
  !*** ./src/app/animations/animation.ts ***!
  \*****************************************/
/*! exports provided: pulse, fadeInLeft, fadeInRight, flipInY, heartBeat, slideInDown, slideInUp, zoomIn, bounce, shake, tada, rotateIn */
    ...
    ContactComponent.prototype.submit = function () {
        ...
        if (this.validMail) {
            this.mailer.sendEmail(this.validMail)
                ...
                .subscribe(function () { return _this.success = "Message Sent"; });
        }
    };
...
module.exports = ".row {\n  margin-left: 10%;\n  margin-right: 10%;\n  text-align: center; }\n\nmdb-card {\n  margin: 10%;\n  background: linear-gradient(to bottom, #7283a7, #45526e);\n  color: #d0d6e2;\n  max-width: 600px;\n  min-height: 400px; }\n\nmdb-card-text {\n  color: #d0d6e2; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ProjectsComponent = /** @class */ (function () {
    ...
    ProjectsComponent.prototype.startAnimation = function (state) {
        if (!this.animationState) {
            this.animationState = state;
        }
    };
    ProjectsComponent.prototype.resetAnimation = function () {
        this.animationState = "";
    };
...
module.exports = ".row {\n  margin-left: 10%;\n  margin-right: 10%;\n  text-align: center; }\n\nmdb-card {\n  margin: 10%;\n  background: linear-gradient(to bottom, #7283a7, #45526e);\n  color: #d0d6e2;\n  min-width: 400px; }\n\nmdb-card-text {\n  color: #d0d6e2; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SkillComponent = /** @class */ (function () {
    function SkillComponent() {
        ...
        //labels
        this.chartLabels1 = ['Angular', 'HTML', 'CSS', 'JavaScript', 'AJAX'];
        this.chartLabels2 = ['Spring MVC', 'Spring ORM', 'Spring Cloud', 'Servlet', 'Hibernate'];
        this.chartLabels3 = ['Apache Tomcat', 'NodeJS', 'JDBC', 'Oracle SQL', 'JSON'];
        this.chartLabels4 = ['JUnit', 'Postman', 'Jasmine', 'Karma', 'Mockito'];
        this.chartLabels5 = ['Java', 'HTML', 'JavaScript', 'TypeScript', 'XML'];
        this.chartLabels6 = ['Jenkins', 'AWS EC2', 'AWS S3', 'Maven', 'Docker'];
        this.chartLabels7 = ['Netflix Eureka', 'Netflix Hystrix', 'Netflix Zuul', 'REST', 'SOAP'];
        this.chartColors = [
            {
