...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">sufyan-fofana documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-34e1ee6c023622975f573c63f59afd81"' : 'data-target="#xs-components-links-module-AppModule-34e1ee6c023622975f573c63f59afd81"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-34e1ee6c023622975f573c63f59afd81"' :
                                            'id="xs-components-links-module-AppModule-34e1ee6c023622975f573c63f59afd81"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/FreeComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">FreeComponent</a>
                                            </li>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#injectables-links-module-AppModule-34e1ee6c023622975f573c63f59afd81"' : 'data-target="#xs-injectables-links-module-AppModule-34e1ee6c023622975f573c63f59afd81"' }>
                                        <span class="icon ion-md-arrow-round-down"></span>
                                        <span>Injectables</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="injectables-links-module-AppModule-34e1ee6c023622975f573c63f59afd81"' :
                                        'id="xs-injectables-links-module-AppModule-34e1ee6c023622975f573c63f59afd81"' }>
                                        <li class="link">
                                        ...
                                        <li class="link">
                                            <a href="injectables/LoggingService.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules" }>LoggingService</a>
                                        </li>
                                        <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/EmailServiceErrorStub.html" data-type="entity-link">EmailServiceErrorStub</a>
                            </li>
                            <li class="link">
                                <a href="classes/EmailServiceStub.html" data-type="entity-link">EmailServiceStub</a>
                            </li>
                            <li class="link">
                                <a href="classes/TestBedProvider.html" data-type="entity-link">TestBedProvider</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
